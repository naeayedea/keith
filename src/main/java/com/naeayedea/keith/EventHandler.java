...
public class EventHandler {
    ...
    private void initialiseCommands() {
        ...
        logger.info("Loaded {} message commmands and {} reaction commands.", commands.size(), reactionCommands.size());
    }
    ...
    public void onGuildJoin(GuildJoinEvent event) {
        ...
        if (defaultChannel != null) {
            defaultChannel.asTextChannel().sendMessageEmbeds(new EmbedBuilder()
                    ...
                    .build()).queue();
            logger.info("New Server "+guild+" has added the bot!");
        }
    ...
    public void onGuildLeave(GuildLeaveEvent event) {
        logger.warn("Server "+event.getGuild()+" has kicked the bot :(");
        Utilities.updateDefaultStatus();
    }
