...
@Component
public class ChatCommand extends AbstractUserCommand {

    private final ServerManager serverManager;

    private final ServerChatManager chatManager;

    public ChatCommand(ServerManager serverManager, ServerChatManager chatManager, @Value("${keith.commands.chat.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.chat.aliases}', ',')}") List<String> commandAliases) {
