...
@Component
public class AvatarCommand extends AbstractUserCommand {

    public AvatarCommand(@Value("${keith.commands.avatar.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.avatar.aliases}', ',')}") List<String> commandAliases) {
