...
@Component
public class EchoTextCommand extends AbstractAdminTextCommand {

    public EchoTextCommand(@Value("${keith.commands.admin.echo.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.echo.aliases}', ',')}") List<String> commandAliases) {
