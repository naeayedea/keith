...
@Component
public class ServerIconTextCommand extends AbstractUserTextCommand {


    public ServerIconTextCommand(@Value("${keith.commands.serverIcon.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.serverIcon.aliases}', ',')}") List<String> commandAliases) {
