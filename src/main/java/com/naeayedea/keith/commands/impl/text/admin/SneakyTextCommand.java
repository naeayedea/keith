 ...
 */
@Component
public class SneakyTextCommand extends AbstractAdminTextCommand {

    public SneakyTextCommand(@Value("${keith.commands.admin.sneaky.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.sneaky.aliases}', ',')}") List<String> commandAliases) {
