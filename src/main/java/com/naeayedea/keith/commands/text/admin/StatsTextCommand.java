...
@Component
public class StatsTextCommand extends AbstractAdminTextCommand {
    ...
    public StatsTextCommand(CandidateManager candidateManager, @Value("${keith.commands.admin.stats.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.stats.aliases}', ',')}") List<String> commandAliases, Database database) {
