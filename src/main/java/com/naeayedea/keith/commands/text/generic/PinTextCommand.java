...
@Component
public class PinTextCommand extends AbstractUserTextCommand implements ReactionCommand {
    ...
    public PinTextCommand(ServerManager serverManager, @Value("${keith.commands.pin.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.pin.aliases}', ',')}") List<String> commandAliases) {
