 ...
 */
@Component
public class SneakyCommand extends AbstractAdminCommand {

    public SneakyCommand(@Value("${keith.commands.admin.sneaky.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.sneaky.aliases}', ',')}") List<String> commandAliases) {
