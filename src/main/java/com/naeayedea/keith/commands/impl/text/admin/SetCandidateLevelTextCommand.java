...
@Component
public class SetCandidateLevelTextCommand extends AbstractAdminTextCommand {

    private final CandidateManager candidateManager;

    private final Logger logger = LoggerFactory.getLogger(SetCandidateLevelTextCommand.class);

    public SetCandidateLevelTextCommand(CandidateManager candidateManager, @Value("${keith.commands.admin.setCandidateLevel.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.setCandidateLevel.aliases}', ',')}") List<String> commandAliases) {
