...
import com.naeayedea.keith.commands.text.channelCommandDrivers.GuessDriver;
...
@Component
public class GuessTextCommand extends AbstractUserTextCommand {

    private final ServerManager serverManager;

    private final ChannelCommandManager channelCommandManager;

    public GuessTextCommand(ServerManager serverManager, ChannelCommandManager channelCommandManager, @Value("${keith.commands.guess.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.guess.aliases}', ',')}") List<String> commandAliases) {
