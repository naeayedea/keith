...
@Component
public class FeedbackCommand extends AbstractUserCommand {

    private final ServerChatManager chatManager;

    private final ServerManager serverManager;

    public FeedbackCommand(ServerChatManager chatManager, ServerManager serverManager, @Value("${keith.commands.feedback.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.feedback.aliases}', ',')}") List<String> commandAliases) {
