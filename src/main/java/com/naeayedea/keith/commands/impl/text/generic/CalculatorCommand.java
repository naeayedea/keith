...
@Component
public class CalculatorCommand extends AbstractUserCommand {

    public CalculatorCommand(@Value("${keith.commands.calculator.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.calculator.aliases}', ',')}") List<String> commandAliases) {
