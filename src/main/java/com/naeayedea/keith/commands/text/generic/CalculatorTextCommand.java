...
@Component
public class CalculatorTextCommand extends AbstractUserTextCommand {

    public CalculatorTextCommand(@Value("${keith.commands.calculator.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.calculator.aliases}', ',')}") List<String> commandAliases) {
