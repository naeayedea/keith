...
@Component
public class AdminUtilitiesCommandPortal extends AbstractCommandPortal {

    private final Logger logger = LoggerFactory.getLogger(AdminUtilitiesCommandPortal.class);
