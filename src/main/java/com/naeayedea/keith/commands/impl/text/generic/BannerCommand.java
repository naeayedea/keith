...
@Component
public class BannerCommand extends AbstractUserCommand {


    public BannerCommand(@Value("${keith.commands.banner.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.banner.aliases}', ',')}") List<String> commandAliases) {
