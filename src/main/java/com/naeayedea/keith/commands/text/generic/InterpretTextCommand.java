...
@Component
public class InterpretTextCommand extends AbstractUserTextCommand {

    public InterpretTextCommand(@Value("${keith.commands.interpret.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.interpret.aliases}', ',')}") List<String> commandAliases) {
