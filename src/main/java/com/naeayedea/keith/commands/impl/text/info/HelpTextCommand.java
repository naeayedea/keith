...
public class HelpTextCommand extends AbstractInfoTextCommand implements StringSelectInteractionHandler {
    ...
    public HelpTextCommand(Map<String, TextCommand> commandMap, ServerManager serverManager, String defaultName, List<String> commandAliases, String defaultEmbedTitle) {
