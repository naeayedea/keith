...
@Component
public class SetStatusTextCommand extends AbstractAdminTextCommand {

    public SetStatusTextCommand(@Value("${keith.commands.admin.setStatus.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.setStatus.aliases}', ',')}") List<String> commandAliases) {
