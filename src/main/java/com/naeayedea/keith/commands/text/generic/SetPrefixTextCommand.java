...
@Component
public class SetPrefixTextCommand extends AbstractUserTextCommand {

    private final int limit;

    private final ServerManager serverManager;

    public SetPrefixTextCommand(ServerManager serverManager, @Value("${keith.commands.setPrefix.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.setPrefix.aliases}', ',')}") List<String> commandAliases) {
