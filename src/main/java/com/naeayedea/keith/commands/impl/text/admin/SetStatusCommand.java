...
@Component
public class SetStatusCommand extends AbstractAdminCommand {

    public SetStatusCommand(@Value("${keith.commands.admin.setStatus.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.setStatus.aliases}', ',')}") List<String> commandAliases) {
