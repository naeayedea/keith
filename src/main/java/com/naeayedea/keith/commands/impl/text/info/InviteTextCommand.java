...
@Component
public class InviteTextCommand extends AbstractInfoTextCommand {

    public InviteTextCommand(@Value("${keith.commands.invite.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.invite.aliases}', ',')}") List<String> commandAliases) {
