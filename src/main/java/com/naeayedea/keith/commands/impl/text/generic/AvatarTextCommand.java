...
@Component
public class AvatarTextCommand extends AbstractUserTextCommand {

    public AvatarTextCommand(@Value("${keith.commands.avatar.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.avatar.aliases}', ',')}") List<String> commandAliases) {
