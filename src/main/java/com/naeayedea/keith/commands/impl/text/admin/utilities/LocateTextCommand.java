...
@Component
public class LocateTextCommand extends AbstractAdminUtilsTextCommand {

    public LocateTextCommand(@Value("${keith.commands.admin.utilities.locate.defaultName}") String defaultName, @Value("#{T(com.naeayedea.keith.converter.StringToAliasListConverter).convert('${keith.commands.admin.utilities.locate.aliases}', ',')}") List<String> commandAliases) {
